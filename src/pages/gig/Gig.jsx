    ...
    <div className="gig">
      <div className="container">
        <div className="left">
          ...
          <div className="user">
            <img
              src="https://images.pexels.com/photos/720327/pexels-photo-720327.jpeg?auto=compress&cs=tinysrgb&w=160"
              alt=""
            />
            <span>John Doe</span>
            <div className="stars">
          ...
          <Slider slidesToShow={1} arrowsScroll={1} className="slider1">
            <img
